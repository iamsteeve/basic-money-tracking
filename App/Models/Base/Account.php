...
abstract class Account implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Models\\Map\\AccountTableMap';
    ...
    /**
     * Initializes internal state of App\Models\Base\Account object.
     */
     ...
     * @return $this|\App\Models\Account The current object (for fluent API support)
     */
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[AccountTableMap::COL_USER_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AccountTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Models\\Account'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->transactionsScheduledForDeletion !== null) {
                if (!$this->transactionsScheduledForDeletion->isEmpty()) {
                    \App\Models\TransactionQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AccountTableMap::COL_USER_ID)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Models\Account The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AccountTableMap::COL_USER_ID)) {
            $criteria->add(AccountTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(AccountTableMap::COL_NAME)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Models\Account (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Models\Account Clone of current object.
     * @throws PropelException
     */
    ...
    public function initTransactions($overrideExisting = true)
    {
        ...
        $this->collTransactions->setModel('\App\Models\Transaction');
    }
     ...
     * @return ObjectCollection|ChildTransaction[] List of ChildTransaction objects
     */
    public function getTransactionsJoinCategory(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTransactionQuery::create(null, $criteria);
