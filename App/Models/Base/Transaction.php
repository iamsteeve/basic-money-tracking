...
abstract class Transaction implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Models\\Map\\TransactionTableMap';
    ...
    /**
     * Initializes internal state of App\Models\Base\Transaction object.
     */
     ...
     * @return $this|\App\Models\Transaction The current object (for fluent API support)
     */
    ...
    public function setCategoryId($v)
    {
        ...
        if ($this->category_id !== $v) {
            $this->category_id = $v;
            $this->modifiedColumns[TransactionTableMap::COL_CATEGORY_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TransactionTableMap::translateFieldName('CategoryId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TransactionTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : TransactionTableMap::translateFieldName('Amount', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Models\\Transaction'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TransactionTableMap::COL_CATEGORY_ID)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Models\Transaction
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Models\Transaction The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TransactionTableMap::COL_CATEGORY_ID)) {
            $criteria->add(TransactionTableMap::COL_CATEGORY_ID, $this->category_id);
        }
        if ($this->isColumnModified(TransactionTableMap::COL_DESCRIPTION)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Models\Transaction (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Models\Transaction Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCategory(ConnectionInterface $con = null)
    {
        if ($this->aCategory === null && ($this->category_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCategory->addTransactions($this);
             */
        }
    ...
    {
        if (null !== $this->aCategory) {
            $this->aCategory->removeTransaction($this);
        }
        if (null !== $this->aAccount) {
