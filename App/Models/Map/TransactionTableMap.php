...
class TransactionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Models.Map.TransactionTableMap';
     ...
     */
    const OM_CLASS = '\\App\\Models\\Transaction';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Models.Transaction';
     ...
     */
    const COL_CATEGORY_ID = 'transaction.category_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'AccountId', 'CategoryId', 'Description', 'Date', 'Amount', ),
        self::TYPE_CAMELNAME     => array('id', 'accountId', 'categoryId', 'description', 'date', 'amount', ),
        self::TYPE_COLNAME       => array(TransactionTableMap::COL_ID, TransactionTableMap::COL_ACCOUNT_ID, TransactionTableMap::COL_CATEGORY_ID, TransactionTableMap::COL_DESCRIPTION, TransactionTableMap::COL_DATE, TransactionTableMap::COL_AMOUNT, ),
        self::TYPE_FIELDNAME     => array('id', 'account_id', 'category_id', 'description', 'date', 'amount', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'AccountId' => 1, 'CategoryId' => 2, 'Description' => 3, 'Date' => 4, 'Amount' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'accountId' => 1, 'categoryId' => 2, 'description' => 3, 'date' => 4, 'amount' => 5, ),
        self::TYPE_COLNAME       => array(TransactionTableMap::COL_ID => 0, TransactionTableMap::COL_ACCOUNT_ID => 1, TransactionTableMap::COL_CATEGORY_ID => 2, TransactionTableMap::COL_DESCRIPTION => 3, TransactionTableMap::COL_DATE => 4, TransactionTableMap::COL_AMOUNT => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'account_id' => 1, 'category_id' => 2, 'description' => 3, 'date' => 4, 'amount' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Account', '\\App\\Models\\Account', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':account_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TransactionTableMap::COL_CATEGORY_ID);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Models\Transaction) { // it's a model object
