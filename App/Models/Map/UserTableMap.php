...
class UserTableMap extends TableMap
{
     ...
     */
    const COL_DISPLAYNAME = 'user.displayName';
    ...
    {
        $this->addRelation('Account', '\\App\\Models\\Account', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
  ),
), null, 'CASCADE', 'Accounts', false);
        $this->addRelation('Category', '\\App\\Models\\Category', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
