...
class AccountTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Models.Map.AccountTableMap';
     ...
     */
    const OM_CLASS = '\\App\\Models\\Account';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Models.Account';
     ...
     */
    const COL_USER_ID = 'account.user_id';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(AccountTableMap::COL_ID, AccountTableMap::COL_USER_ID, AccountTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(AccountTableMap::COL_ID => 0, AccountTableMap::COL_USER_ID => 1, AccountTableMap::COL_NAME => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Models\\Account');
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Transaction', '\\App\\Models\\Transaction', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':account_id',
    1 => ':id',
  ),
), null, 'CASCADE', 'Transactions', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AccountTableMap::COL_USER_ID);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Models\Account) { // it's a model object
